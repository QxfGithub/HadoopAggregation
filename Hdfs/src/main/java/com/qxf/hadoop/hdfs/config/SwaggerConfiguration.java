...
public class SwaggerConfiguration {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.qxf.hadoop.hdfs")).paths(PathSelectors.any())
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder().title("Hdfs web API  DOC").contact(contact).description("Hdfs服务").build();
    }
